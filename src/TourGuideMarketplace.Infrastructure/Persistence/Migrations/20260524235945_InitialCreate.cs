        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreferredLanguage = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                name: "GuideVerifications",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    GuideProfileId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DocumentType = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: false),
                    DocumentUrl = table.Column<string>(type: "nvarchar(600)", maxLength: 600, nullable: false),
                    LicenseNumber = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GuideVerifications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GuideVerifications_GuideProfiles_GuideProfileId",
                        column: x => x.GuideProfileId,
                        principalTable: "GuideProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TouristProfileId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    GuideProfileId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    Currency = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    TouristNotes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Currency = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false),
                    PlatformFeeAmount = table.Column<decimal>(type: "decimal(12,2)", precision: 12, scale: 2, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1647b982-7a3f-4648-9f01-f912fc2989ae"), "1647b982-7a3f-4648-9f01-f912fc2989ae", "Admin", "ADMIN" },
                    { new Guid("7f3eb40e-dfeb-4d9c-a978-3ecbe439f158"), "7f3eb40e-dfeb-4d9c-a978-3ecbe439f158", "Tourist", "TOURIST" },
                    { new Guid("ab6eaedb-d0be-483f-b76e-a0b2ec2d0cb1"), "ab6eaedb-d0be-483f-b76e-a0b2ec2d0cb1", "Guide", "GUIDE" }
                });

            migrationBuilder.CreateIndex(
                name: "IX_Bookings_GuideProfileId_StartsAt_EndsAt",
                table: "Bookings",
                columns: new[] { "GuideProfileId", "StartsAt", "EndsAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GuideProfiles_City_Country",
                table: "GuideProfiles",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GuideVerifications_GuideProfileId",
